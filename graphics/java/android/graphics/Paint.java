...
public class Paint {
    ...
    public void getTextPath(char[] text, int index, int count,
        ...
        native_getTextPath(mNativePaint, Canvas.bidiProcess(text, index, count), 0, count, x, y, path.ni());
    }
	...
	String bidiText = new String(Canvas.bidiProcess(text.toCharArray(), start, end-start));
        native_getTextPath(mNativePaint, bidiText, 0, bidiText.length(), x, y, path.ni());
    }
